...
def import_data():
    ...
    page_project_5.text = 'This was a project in the Web Development course at Westminster University. The class was about computer science students working with designers from the Communications class that was paired with ours. Over the course of 4 months we as developers learned the software we were going to be using and made a website for a real client. We had meetings with the client so that we could make the best website that we could for them. As developers we had to make decisions on what we could and could not do with the time we had in the class. It was overall an amazing experience working with people and getting a taste of what working in industry may be like in the future. \r\n\r\nOur specific project was working with the President of the <a class="text-thistle" target="_blank" rel="norefferer" href="https://jaclslc.pythonanywhere.com">SLC chapter of the Japanese American Citizen\'s League(JACL)<a/> to create a website for their online presence. At the point that we started working with them, they only had a facebook page. Our first step was to determine what the president wanted for the website. The president wanted most of the website to be editable by herself or a social media person without having to take the website down. This necessitated a large change from just sticking text into an HTML page. We had to make database entries for each page on the website that were editable through Django\'s admin panel. Our team worked great together on the things we were best at and I even made one of the pages myself. At that time, I really wasn\'t the most experienced with CSS, so creating something that worked well with differing screen sizes was a bit of a challenge. \r\n<hr>\r\n<img class="rounded-3 w-50 img-fluid" alt="The Join page of the website" src="/static/images/joinjacl.jpg">\r\n<br>\r\n<br>\r\nThis was the page I worked on. The circles are absolutely positioned and snap to the center when the screen size of the device the website is displayed on is too small. \r\n<br>\r\n<br>\r\n<img class="rounded-3 img-fluid" alt="The footer of the Join page" src="/static/images/joinfooter.jpg">\r\n<br>\r\n<br>\r\nHere is the bottom of the join page that contains a link to the official application form.\r\n<br>\r\n<br>\r\nSome of the other pages on the website include the home page which has a carousel of images from JACL SLC\'s recent events, a calendar page with most recent events at the top of the page, a statements page with editable statements and a mission and vision page which has the SLC Chapter\'s mission and vision.\r\n<hr>\r\n<div class="row-cols-auto">\r\n    <img class="rounded-3 m-3 w-75 img-fluid" alt="This is the homepage" src="/static/images/homepage.jpg">\r\n    <img class="rounded-3 m-3 w-75 img-fluid" alt="This is the upcoming events on the events page" src="/static/images/events.jpg">\r\n    <img class="rounded-3 m-3 w-75 img-fluid" alt="This is the calendar of the events page" src="/static/images/calendar.jpg">\r\n    <img class="rounded-3 m-3 w-75 img-fluid" alt="This is the statements page" src="/static/images/statements.jpg">\r\n    <img class="rounded-3 m-3 w-75 img-fluid" alt="This is the mission and vision page" src="/static/images/missionandvision.jpg">\r\n</div>'
    page_project_5 = importer.save_or_locate(page_project_5)

    # Processing model: page.models.Keyboard

    from page.models import Keyboard

    page_keyboard_1 = Keyboard()
    page_keyboard_1.title = 'Watermelon ID75'
    page_keyboard_1.image = 'watermelon_FK5dBJL.jpg'
    page_keyboard_1.text = '<img src="/static/images/watermelon_FK5dBJL.jpg" alt="A picture of Watermelon keyboard" class="rounded-3 w-50 img-fluid">\r\n<hr>\r\n<br>\r\nThis is my Watermelon themed ID75. I absolutely love this board and the customizations I\'ve made to it. I have a numpad under my left hand, I have media control keys, I used 2 separate keycap sets to get the look I wanted, I have watermelon seeds in the Gateron Ink Black keyswitches under the keycaps. I just love it.'
    page_keyboard_1 = importer.save_or_locate(page_keyboard_1)

    page_keyboard_2 = Keyboard()
    page_keyboard_2.title = 'CTSC40'
    page_keyboard_2.image = 'CTSC40.jpg'
    page_keyboard_2.text = '<img src="/static/images/CTSC40.jpg" alt="A picture of CTSC keyboard" class="rounded-3 w-50 img-fluid">\r\n<hr>\r\n<br>\r\nThis is my first and only 40% keyboard. I had an idea in mind when I was planning this keyboard, that it would look like the Toxic Waste color scheme with lime/neon green and purple. This keyboard started as a simple black and white board, but with the correct keycaps and a simple paintjob it looks perfect. This keyboard uses the DOYS keycaps that make it look like an OP-1 from Teenage Engineering. The switches on this board are the Cherry MX Purples made in collaboration with Glarses. These are my favorite tactile switches I have ever tried, even though I don\'t use this board too much.'
    page_keyboard_2 = importer.save_or_locate(page_keyboard_2)

    page_keyboard_3 = Keyboard()
    page_keyboard_3.title = 'Bubblegum'
    page_keyboard_3.image = 'bubblegum.jpg'
    page_keyboard_3.text = '<img src="/static/images/bubblegum.jpg" alt="A picture of CTSC keyboard" class="rounded-3 w-50 img-fluid">\r\n<hr>\r\n<br>\r\nThis started off as a simple black keyboard with rgb and keycaps that could have lights shine through. As it was my second custom mechanical keyboard I was more focused on the size and layout and less focused on the look. I wanted something simple and useful. Over the years since I made the board however, I started to want something more fun looking. And when I saw that the new Ceramic keycaps from CeraKeys were available to buy, I bought a mixed set and put it on this board. Once I had them on, I realized that the black casing with the lighter color keycaps didn\'t look quite right. So, I decided to paint the case white and it turned out beautifully.'
    page_keyboard_3 = importer.save_or_locate(page_keyboard_3)
    ...
    page_home_1 = Home()
    page_home_1.bio_text = "Hello! My name is Zoe, and I have a bachelor's in Computer Science from Westminster University. I have a huge penchant for problem solving and I love learning. Computers and their intricacies are my passion, as I have been curious about them since I was 10 years old. \r\n<br>\r\n<br>\r\nSince college, I have gotten a couple of IT related jobs and I would love to have a system administrator role in the future. I have lots to learn before I can manage anything on a production scale, but I have already begun setting up services for my family and friends at home using tools like Proxmox and Docker to host and manage them. \r\n<br>\r\n<br>\r\nThis website was built using experience gained working on the SLC chapter of the Japanese American's Citizens League's website with Django and Bootstrap."
    ...
    page_skill_4.experience = 'Django has become a resource for me to build websites as I already had a foundation in python.'
    ...
    page_skill_7 = Skill()
    page_skill_7.name = 'Antlr4'
    page_skill_7.logo = 'antlr4.png'
    page_skill_7.experience = 'Antlr was a tool I picked up so that I could make a compiler for a language similar to Java.'
    page_skill_7 = importer.save_or_locate(page_skill_7)

    page_skill_8 = Skill()
    page_skill_8.name = 'Docker'
    page_skill_8.logo = 'docker.webp'
    page_skill_8.experience = 'I picked up Docker recently to run apps in a simpler way. Starting to package my own apps with it.'
